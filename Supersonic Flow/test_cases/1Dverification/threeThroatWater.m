...
dblThrt = load('tripleThroat.mat', 'p_e_ratio');%0.3255;%0.292927099161134;%0.4101;
% u_e = dblThrt.u_1;
p_e = dblThrt.p_e_ratio;

% UU = [2*rho0; (2*rho0)*(0.1*u0)].*g_x;
...
oldResults = load('threeThroatIsentropic\run_1.mat', 'UU');
UU = oldResults.UU;
clear oldResults;
